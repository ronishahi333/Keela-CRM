<template>
  ...
  >
    <div class="flex items-center">
      ...
      <div class="ml-2 text-sm font-normal">Tag saved successfully.</div>
    </div>
  </div>
    ...
    <div class="col-start-6 justify-self-end">
      ...
      >
        <div class="flex items-center">
          ...
          <div class="ml-2 text-sm font-normal">Tag deleted successfully</div>
        </div>
      </div>
    </div>
  </div>
  ...
  methods: {
    ...
    deleteTag(tagId) {
      ...
      Meteor.call("tags.remove", tagId, (error) => {
        if (error) {
          console.error("Error deleting tag:", error.reason);
        } else {
