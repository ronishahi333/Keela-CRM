...
export default {
  ...
  setup() {
    ...
    const OrgDeleteModal = ref(false);
    ...
    function OrgDeleteToggleModal() {
      OrgDeleteModal.value = !OrgDeleteModal.value;
    }
